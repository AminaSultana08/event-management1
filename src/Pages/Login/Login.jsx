    ...
    return (
      ...
      <div className="h-full">
       {/**Left column container with background */}
        ...
        <button onClick={handleSignInGoogle}  className="flex items-center box-border border-2 rounded-3xl w-60 p-2 border-gray-400 gap-2"><FcGoogle  className="mr-3"></FcGoogle>  Continue with Google</button>
        <button onClick={handleSignInGithub}  className="flex items-center box-border border-2 rounded-3xl w-60 p-2 border-gray-400 gap-2"><FaGithub  className="mr-3"></FaGithub>  Continue with GitHub</button>
        </div>
      </div>
          </div>
